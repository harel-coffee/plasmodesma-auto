...
the prgm is fully tested under
SPIKE 0.99.30
numpy 1.19.1
scipy 1.5.2
python 3.8.5
...
Config = {
    ...
    'TMS' : False,          # if true, TMS (or any 0 ppm reference) is supposed to be present and used for ppm calibration
...
def set_param(DIREC='.'):
    ...
    try:
        ...
        print('*** ATTENTION - no RunConfig.json file found - using default configuration')
    else:  # if no error
